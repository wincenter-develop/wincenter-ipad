...
#import "NetworkInsideVC.h"
#import "NetworkInsideCell.h"

@interface NetworkInsideVC ()

@end

@implementation NetworkInsideVC
...
{
    NetworkInsideCell *cell = [tableView dequeueReusableCellWithIdentifier:@"NetworkInsideCell" forIndexPath:indexPath];
